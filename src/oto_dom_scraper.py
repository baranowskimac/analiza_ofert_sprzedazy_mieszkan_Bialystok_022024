...
class OtodomDataScraper:
    ...
    def create_link_page_to_download(self, page_counter):
        """
    ...
    def create_list_of_ulrs(self, soup) -> list:
        """
        Function to extract from Oto Dom page links to download data from particular ads

        Args:
            soup (bs4.BeautifulSoup): bs4.BeautifulSoup object

        Returns:
            list: List of link to the ads from given page
    ...
    def extract_olx_data(self, list_of_url: list) -> pd.DataFrame:
        ...
        for index, one_url in enumerate(list_of_url):
            ...
            json_data = json.loads(
                soup_one_add.find("script", type="application/json").text
            )

            # extract fields from json in ads. Try except in selected field - if field doesn;t extis
            try:
                add_details_df["lang"] = pd.json_normalize(
            ...
            try:
                add_details_df["ad_id"] = pd.json_normalize(
                    json_data["props"]["pageProps"]
                )["id"]
            except KeyError:
            ...
            try:
                add_details_df["url"] = pd.json_normalize(
                    json_data["props"]["pageProps"]
                )["relativeUrl"]
            except KeyError:
            ...
            try:
                add_details_df["ad_id2"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["id"]
            except KeyError:
                add_details_df["ad_id2"] = "None"

            try:
                add_details_df["market"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["market"]
            except KeyError:
            ...
            try:
                add_details_df["publicId"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["publicId"]
            except KeyError:
            ...
            try:
                add_details_df["slug"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["slug"]
            except KeyError:
            ...
            try:
                add_details_df["advertiserType"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["advertiserType"]
            except KeyError:
            ...
            try:
                add_details_df["createdAt"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["createdAt"]
            except KeyError:
            ...
            try:
                add_details_df["modifiedAt"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["modifiedAt"]
            except KeyError:
            ...
            try:
                add_details_df["description"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["description"]
            except KeyError:
            ...
            try:
                add_details_df["title"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["title"]
            except KeyError:
            ...
            try:
                add_details_df["full_url"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]
                )["url"]
            except KeyError:
            ...
            try:
                add_details_df["price"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["characteristics"]
                ).query("key == 'price'")["value"]
            except KeyError:
                add_details_df["price"] = "None"

            try:
                add_details_df["m"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["characteristics"]
                ).query("key == 'm'")["value"]
            except KeyError:
            ...
            try:
                add_details_df["price_per_m"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["characteristics"]
                ).query("key == 'price_per_m'")["value"]
            except KeyError:
                add_details_df["price_per_m"] = "None"

            try:
                add_details_df["rooms_num"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["characteristics"]
                ).query("key == 'rooms_num'")["value"]
            except KeyError:
                add_details_df["rooms_num"] = "None"

            try:
                add_details_df["floor_no"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["characteristics"]
                ).query("label == 'Piętro'")["localizedValue"]
            except KeyError:
                add_details_df["floor_no"] = "None"

            try:
                add_details_df["heating"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["characteristics"]
                ).query("key == 'heating'")["value"]
            except KeyError:
                add_details_df["heating"] = "None"

            try:
                add_details_df["building_ownership"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["characteristics"]
                ).query("key == 'building_ownership'")["value"]
            except KeyError:
                add_details_df["building_ownership"] = "None"

            try:
                add_details_df["city"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["target"]
                )["City"]
            except KeyError:
                add_details_df["city"] = "None"

            try:
                add_details_df["City_id"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["target"]
                )["City_id"]
            except KeyError:
            ...
            try:
                add_details_df["Country"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["target"]
                )["Country"]
            except KeyError:
            ...
            try:
                add_details_df["MarketType"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["target"]
                )["MarketType"]
            except KeyError:
            ...
            try:
                add_details_df["PriceRange"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["target"]
                )["PriceRange"]
            except KeyError:
            ...
            try:
                add_details_df["latitude"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["location"]["coordinates"]
                )["latitude"]
            except KeyError:
                add_details_df["latitude"] = "None"

            try:
                add_details_df["longitude"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["location"]["coordinates"]
                )["longitude"]
            except KeyError:
            ...
            try:
                add_details_df["district_name"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["location"]["address"]
                )["district.code"]
            except KeyError:
                add_details_df["district_name"] = "None"

            try:
                add_details_df["district.id"] = pd.json_normalize(
                    json_data["props"]["pageProps"]["ad"]["location"]["address"]
                )["district.id"]
            except KeyError:
    ...
    def download_data(self):
        ...
        while running:
            ...
            next_link_to_download = scrape_otodom_data.create_link_page_to_download(
            ...
            next_soup_page = scrape_otodom_data.define_page_to_extract(
                self, page_url=next_link_to_download
            )

            # step 3 - find all links (ads) on the scrapped pag

            next_list_of_ads_links = scrape_otodom_data.create_list_of_ulrs(
                self, soup=next_soup_page
            )

            # step 4 - extract all details from found ads on the page
            try:
                next_ads_details = scrape_otodom_data.extract_olx_data(
                    self, list_of_url=next_list_of_ads_links
                )
                next_ads_details.to_csv(
                    f"{self.path_to_save_batch_files}/data_part_{page_counter}_{date_of_download}.csv"
                )
            except ValueError:
                running = False
        ...
        full_ds.to_csv(
            f"{self.path_to_save_full_files}/full_oto_dom_data_{date_of_download}.csv"
        )
